...
from Users.views import (
    BlockUserView,
    UnblockUserView,
    BlockUserConfirmationView,
    UnBlockUserConfirmationView,
    UserDetailView,
)
...
urlpatterns = [
    ...
    path(
        "user/<int:user_id>/block/confirm/",
        BlockUserConfirmationView.as_view(),
        name="user_block_confirm",
    ),
    path(
        "user/<int:user_id>/unblock/confirm/",
        UnBlockUserConfirmationView.as_view(),
